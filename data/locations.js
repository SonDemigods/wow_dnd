/**
 * World Data Module
 * Contains all world locations and continent data
 */
...
const WORLD_LOCATIONS = {
  ...
  azuremyst: {
    ...
    continent: 'kalimdor',
    region: 'north',
    enemies: ['murloc', 'spider', 'elemental'],
    levelRange: [1, 5],
    color: '#4169e1',
    mapX: 7,
    mapY: 40
  ...
  plaguelands: {
    ...
    region: 'north',
    enemies: ['undead', 'undead_knight', 'lich', 'demon'],
    levelRange: [15, 20],
    color: '#556b2f',
    mapX: 87,
    mapY: 35
  ...
  elwynn: {
    ...
    continent: 'eastern_kingdoms',
    region: 'center',
    enemies: ['kobold', 'goblin', 'wolf', 'boar'],
    levelRange: [1, 5],
    color: '#228b22',
    mapX: 77,
    mapY: 75
  ...
  icecrown: {
    ...
    continent: 'northrend',
    region: 'north',
    enemies: ['lich', 'undead_knight', 'demon', 'frostwyrm'],
    levelRange: [17, 20],
    color: '#b0c4de',
    mapX: 48,
    mapY: 13
