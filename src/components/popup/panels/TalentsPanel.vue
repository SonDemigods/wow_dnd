...
/**
 * @fileoverview 天赋面板内容组件（无 BasePopup 外壳）
 * @description 展示天赋树网格、点数分配与节点详情。供 BuildPopup 分段复用。
 */
...
function colColor(col?: number): string {
  switch (col) {
    case 1: return TALENT_COL1_COLOR;
    case 2: return TALENT_COL2_COLOR;
    case 3: return TALENT_COL3_COLOR;
