 ...
 * 敌人属性等级缩放系数
 *
 * levelScale = 1 + (level - 1) × 该系数。
 * 每级提升该比例的 HP/攻击/防御/经验/金币。
 *
 * B-100 修复：原值 0.1（10%/级）导致高等级 Boss HP 爆表
 * （虚空领主 Lv16: 380×2.5=950 HP，需 70+ 回合击杀）。
 * 降至 6%/级后 Lv16 缩放 1.9×，虚空领主 HP 722，约 15 回合可击杀。
 *
 * @see src/modules/enemy/service.ts generateEnemyStats
 */
export const ENEMY_LEVEL_SCALE_COEFFICIENT = 0.06;
