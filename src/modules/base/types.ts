...
export interface IBaseService {
  ...
  createFaction(data: FactionCreateUpdateData): Promise<BaseOperationResult<string>>;
  updateFaction(id: string, data: FactionCreateUpdateData): Promise<BaseOperationResult>;
  deleteFaction(id: string): Promise<BaseOperationResult>;
  ...
  createRace(data: RaceCreateUpdateData): Promise<BaseOperationResult<string>>;
  updateRace(id: string, data: RaceCreateUpdateData): Promise<BaseOperationResult>;
  deleteRace(id: string): Promise<BaseOperationResult>;
  ...
  createClass(data: ClassCreateUpdateData): Promise<BaseOperationResult<string>>;
  updateClass(id: string, data: ClassCreateUpdateData): Promise<BaseOperationResult>;
  deleteClass(id: string): Promise<BaseOperationResult>;
}
