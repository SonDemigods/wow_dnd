...
export const CLASS_PASSIVES: PassiveSkill[] = [
  ...
  {
    id: 'paladin_holy_power_mastery',
    name: '圣能精通',
    description: '神圣攻击力提升 10%',
  ...
  {
    id: 'paladin_divine_purpose',
    name: '神圣使命',
    description: '使用神圣能量技能后，15% 概率返还 1 点神圣能量',
  ...
  {
    id: 'hunter_focus_mastery',
    name: '集中值掌控',
    description: '战斗开始时获得 30 点集中值',
    icon: 'game-icons:archery-target',
    classId: 'hunter',
    trigger: 'on_combat_start',
    effect: {
  ...
  {
    id: 'hunter_pet_synergy',
    name: '野兽协同',
    description: '攻击命中时有 30% 概率获得 3 点集中值',
  ...
  },
  {
    ...
    name: '刺客大师',
    description: '目标生命低于 20% 时，物理攻击力提升 15%',
    icon: 'game-icons:assassin-pocket',
    classId: 'rogue',
    trigger: 'passive',
    effect: {
      type: 'stat_modifier',
  ...
  },
  {
    ...
    name: '灵魂收割',
    description: '战斗开始时汲取战场灵魂，获得 2 灵魂碎片',
  ...
  {
    id: 'shaman_stone_bulwark',
    name: '石壁图腾',
    description: '生命低于 50% 时，受到伤害减少 15%',
  ...
  {
    id: 'death_knight_runic_mastery',
    name: '符文掌控',
    description: '魔法攻击力提升 10%',
  ...
  {
    id: 'death_knight_vampiric_blood',
    name: '吸血之血',
    description: '生命低于 30% 时，攻击命中恢复造成伤害 8% 的生命',
    icon: 'game-icons:bleeding-heart',
    classId: 'death_knight',
    trigger: 'on_low_hp',
    effect: {
  ...
  {
    id: 'death_knight_frost_strike_mastery',
    name: '冰霜精通',
    description: '使用符文技能时，20% 概率获得 3 点符文能量',
  ...
  {
    id: 'monk_power_strikes',
    name: '力之拳',
    description: '攻击命中时有 30% 概率获得 1 真气',
    icon: 'game-icons:fist',
    classId: 'monk',
    trigger: 'on_attack',
    effect: {
  ...
  {
    id: 'monk_combat_conditioning',
    name: '战斗调息',
    description: '物理攻击力提升 10%',
  ...
  {
    id: 'demon_hunter_soul_harvest',
    name: '灵魂收割',
    description: '战斗开始时汲取战场灵魂，获得 1 点灵魂',
    icon: 'game-icons:soul-vessel',
    classId: 'demon_hunter',
    trigger: 'on_combat_start',
    effect: {
  ...
  {
    id: 'demon_hunter_blade_master',
    name: '刃舞大师',
    description: '攻击命中时有 30% 概率获得 1 点灵魂',
  ...
  {
    id: 'evoker_obsidian_scales',
    name: '黑曜石龙鳞',
    description: '生命低于 30% 时，黑曜石龙鳞硬化，受到伤害减少 20%',
    icon: 'game-icons:scale-mail',
    classId: 'evoker',
    trigger: 'on_low_hp',
    effect: {
  ...
  {
    id: 'evoker_essence_surge',
    name: '精华涌动',
    description: '战斗开始时立即获得 1 点精华',
    icon: 'game-icons:dragon-head',
    classId: 'evoker',
    trigger: 'on_combat_start',
    effect: {
  ...
  {
    id: 'evoker_dragons_fury',
    name: '龙之怒',
    description: '击杀敌人后恢复 5% 最大生命',
