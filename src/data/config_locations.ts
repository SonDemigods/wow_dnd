...
export const LOCATIONS: LocationData[] = [
  {
    ...
    bosses: ['boss_murloc_chieftain', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#2d5a3d',
    mapX: 15,
    mapY: 27,
  ...
  },
  {
    ...
    bosses: ['boss_centaur_khan', 'boss_naga_seawitch'],
    levelRange: [5, 10],
    color: '#2c3e50',
    mapX: 18,
    mapY: 35,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_gnoll', 'mob_strider'],
    bosses: ['boss_hogger', 'boss_murloc_chieftain'],
    levelRange: [1, 5],
    color: '#4169e1',
    mapX: 7,
    mapY: 40,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_poison_spider', 'mob_wraith'],
    bosses: ['boss_naga_seawitch', 'boss_troll_warlord'],
    levelRange: [5, 10],
    color: '#8b0000',
    mapX: 5,
    mapY: 35,
  ...
  },
  {
    ...
    bosses: ['boss_shadow_assassin', 'boss_demon_lord'],
    levelRange: [10, 14],
    color: '#9932cc',
    mapX: 21,
    mapY: 39,
  ...
  },
  {
    ...
    bosses: ['boss_demon_lord', 'boss_rock_lord'],
    levelRange: [12, 16],
    color: '#8b4513',
    mapX: 14,
    mapY: 60,
  ...
  },
  {
    ...
    bosses: ['boss_demon_lord', 'boss_void_lord'],
    levelRange: [15, 20],
    color: '#8b4513',
    mapX: 16,
    mapY: 85,
  ...
  },
  {
    ...
    enemies: ['mob_plaguebearer', 'mob_death_knight_mob', 'mob_dark_caster', 'mob_ice_troll'],
    bosses: ['boss_undead_knight', 'boss_lich', 'boss_death_lord'],
    levelRange: [15, 20],
    color: '#556b2f',
    mapX: 87,
    mapY: 35,
  ...
  },
  {
    ...
    bosses: ['boss_demon_lord', 'boss_centaur_khan'],
    levelRange: [10, 14],
    color: '#8b7355',
    mapX: 84,
    mapY: 52,
  ...
  },
  {
    ...
    bosses: ['boss_demon_lord', 'boss_shadow_assassin'],
    levelRange: [13, 17],
    color: '#8b008b',
    mapX: 81,
    mapY: 83,
  ...
  },
  {
    ...
    bosses: ['boss_troll_warlord', 'boss_naga_seawitch'],
    levelRange: [8, 13],
    color: '#2f4f4f',
    mapX: 85,
    mapY: 78,
  ...
  },
  {
    ...
    bosses: ['boss_lich', 'boss_undead_knight', 'boss_frost_wyrm', 'boss_death_lord'],
    levelRange: [17, 20],
    color: '#b0c4de',
    mapX: 48,
    mapY: 13,
