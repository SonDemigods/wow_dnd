...
export const LOCATIONS: LocationData[] = [
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_poison_spider', 'mob_gray_wolf', 'mob_gnoll'],
    bosses: ['boss_abyss_guard'],
    levelRange: [1, 5],
    color: '#2d5a3d',
    mapX: 15,
    mapY: 27,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_murloc', 'mob_brown_bear', 'mob_gnoll'],
    bosses: ['boss_abyss_guard'],
    levelRange: [5, 10],
    color: '#2c3e50',
    mapX: 18,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_elemental', 'mob_gnoll'],
    bosses: ['boss_abyss_guard'],
    levelRange: [1, 5],
    color: '#4169e1',
    mapX: 7,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_elemental', 'mob_poison_spider'],
    bosses: ['boss_abyss_guard'],
    levelRange: [5, 10],
    color: '#8b0000',
    mapX: 5,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_elemental'],
    bosses: ['boss_abyss_guard', 'boss_dragon_whelp'],
    levelRange: [14, 18],
    color: '#87ceeb',
    mapX: 27,
    mapY: 34,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_orc_grunt', 'mob_poison_spider', 'mob_harpy', 'mob_gray_wolf'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [5, 10],
    color: '#228b22',
    mapX: 21,
    mapY: 45,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_elemental', 'mob_poison_spider'],
    bosses: ['boss_abyss_guard'],
    levelRange: [10, 14],
    color: '#9932cc',
    mapX: 21,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_orc_grunt', 'mob_poison_spider', 'mob_quilboar'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [7, 11],
    color: '#8b7355',
    mapX: 16,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_skeleton', 'mob_elemental', 'mob_scorpid'],
    bosses: ['boss_abyss_guard'],
    levelRange: [12, 16],
    color: '#8b4513',
    mapX: 14,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_boar', 'mob_scorpid', 'mob_quilboar'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [1, 5],
    color: '#d4a574',
    mapX: 27,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_boar', 'mob_gray_wolf', 'mob_brown_bear', 'mob_quilboar'],
    bosses: ['boss_abyss_guard'],
    levelRange: [1, 5],
    color: '#8fbc8f',
    mapX: 20,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_quilboar', 'mob_centaur', 'mob_boar', 'mob_orc_grunt'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [5, 10],
    color: '#daa520',
    mapX: 23,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_poison_spider', 'mob_harpy'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [10, 14],
    color: '#cd853f',
    mapX: 20,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_skeleton', 'mob_ogre', 'mob_scorpid'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [11, 15],
    color: '#daa520',
    mapX: 25,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_ogre', 'mob_naga'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [13, 17],
    color: '#228b22',
    mapX: 15,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_silithid', 'mob_elemental'],
    bosses: ['boss_abyss_guard'],
    levelRange: [15, 20],
    color: '#8b4513',
    mapX: 16,
  ...
  },
  {
    ...
    enemies: ['mob_undead', 'mob_skeleton'],
    bosses: ['boss_undead_knight', 'boss_lich', 'boss_abyss_guard'],
    levelRange: [15, 20],
    color: '#556b2f',
    mapX: 87,
    mapY: 35,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_ghoul', 'mob_skeleton'],
    bosses: ['boss_lich'],
    levelRange: [13, 17],
    color: '#4a4a4a',
    mapX: 82,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_gray_wolf', 'mob_skeleton', 'mob_ghoul'],
    bosses: ['boss_undead_knight'],
    levelRange: [4, 8],
    color: '#556b2f',
    mapX: 75,
    mapY: 46,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_skeleton', 'mob_ghoul', 'mob_undead', 'mob_gray_wolf'],
    bosses: ['boss_lich'],
    levelRange: [1, 5],
    color: '#4a4a4a',
    mapX: 77,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_kobold', 'mob_brown_bear', 'mob_poison_spider', 'mob_ogre'],
    bosses: ['boss_frost_giant'],
    levelRange: [5, 10],
    color: '#4682b4',
    mapX: 77,
    mapY: 64,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_jungle_troll', 'mob_ogre'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [7, 12],
    color: '#556b2f',
    mapX: 85,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_jungle_troll', 'mob_ogre', 'mob_elemental'],
    bosses: ['boss_abyss_guard'],
    levelRange: [10, 14],
    color: '#8b7355',
    mapX: 84,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_gray_wolf', 'mob_brown_bear', 'mob_shadow_bandit'],
    bosses: ['boss_undead_knight'],
    levelRange: [6, 11],
    color: '#90ee90',
    mapX: 79,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_kobold', 'mob_gnoll', 'mob_gray_wolf', 'mob_boar', 'mob_shadow_bandit'],
    bosses: ['boss_abyss_guard'],
    levelRange: [1, 5],
    color: '#228b22',
    mapX: 77,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_shadow_bandit', 'mob_skeleton', 'mob_gnoll'],
    bosses: ['boss_undead_knight'],
    levelRange: [5, 10],
    color: '#d4a574',
    mapX: 74,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_poison_spider', 'mob_ogre', 'mob_kobold'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [8, 12],
    color: '#cd853f',
    mapX: 83,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_skeleton', 'mob_undead', 'mob_poison_spider', 'mob_ghoul'],
    bosses: ['boss_undead_knight'],
    levelRange: [7, 11],
    color: '#4b0082',
    mapX: 79,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_elemental'],
    bosses: ['boss_abyss_guard'],
    levelRange: [13, 17],
    color: '#8b008b',
    mapX: 81,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_jungle_troll', 'mob_ogre', 'mob_naga', 'mob_tiger', 'mob_orc_grunt'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [10, 15],
    color: '#228b22',
    mapX: 78,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_elemental'],
    bosses: ['boss_dragon_whelp', 'boss_abyss_guard'],
    levelRange: [14, 18],
    color: '#ff4500',
    mapX: 80,
    mapY: 69,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_elemental', 'mob_orc_grunt', 'mob_poison_spider'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [12, 16],
    color: '#8b0000',
    mapX: 80,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_elemental', 'mob_ogre', 'mob_dark_iron_dwarf', 'mob_poison_spider'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [11, 15],
    color: '#a0522d',
    mapX: 85,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_jungle_troll', 'mob_elemental'],
    bosses: ['boss_abyss_guard'],
    levelRange: [8, 13],
    color: '#2f4f4f',
    mapX: 85,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_jungle_troll', 'mob_gray_wolf', 'mob_brown_bear', 'mob_ogre'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [11, 16],
    color: '#228b22',
    mapX: 87,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_vrykul', 'mob_undead', 'mob_jungle_troll'],
    bosses: ['boss_lich'],
    levelRange: [14, 18],
    color: '#8b0000',
    mapX: 61,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_iron_dwarf', 'mob_elemental'],
    bosses: ['boss_frost_giant', 'boss_dragon_whelp'],
    levelRange: [16, 20],
    color: '#708090',
    mapX: 56,
    mapY: 10,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_undead'],
    bosses: ['boss_lich', 'boss_undead_knight', 'boss_abyss_guard', 'boss_frost_wyrm'],
    levelRange: [17, 20],
    color: '#b0c4de',
    mapX: 48,
    mapY: 13,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_nerubian', 'mob_jungle_troll', 'mob_elemental'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [12, 16],
    color: '#2f4f4f',
    mapX: 41,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_vrykul', 'mob_jungle_troll', 'mob_gray_wolf', 'mob_brown_bear'],
    bosses: ['boss_frost_giant'],
    levelRange: [12, 16],
    color: '#696969',
    mapX: 63,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_undead'],
    bosses: ['boss_dragon_whelp', 'boss_lich', 'boss_frost_wyrm'],
    levelRange: [15, 19],
    color: '#4a4a4a',
    mapX: 53,
    mapY: 23,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_brown_bear', 'mob_gray_wolf', 'mob_orc_grunt', 'mob_elemental'],
    bosses: ['boss_undead_knight'],
    levelRange: [13, 17],
    color: '#228b22',
    mapX: 61,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_tiger', 'mob_poison_spider', 'mob_elemental'],
    bosses: ['boss_dragon_whelp'],
    levelRange: [14, 18],
    color: '#228b22',
    mapX: 43,
