...
export const LOCATIONS: LocationData[] = [
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_poison_spider', 'mob_gray_wolf', 'mob_gnoll', 'mob_strider'],
    bosses: ['boss_abyss_guard', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#2d5a3d',
    mapX: 15,
    mapY: 27,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_murloc', 'mob_brown_bear', 'mob_gnoll', 'mob_makrura', 'mob_wraith'],
    bosses: ['boss_abyss_guard', 'boss_naga_seawitch'],
    levelRange: [5, 10],
    color: '#2c3e50',
    mapX: 18,
    mapY: 35,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_elemental', 'mob_gnoll', 'mob_strider'],
    bosses: ['boss_abyss_guard', 'boss_murloc_chieftain'],
    levelRange: [1, 5],
    color: '#4169e1',
    mapX: 7,
    mapY: 40,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_elemental', 'mob_poison_spider', 'mob_wraith'],
    bosses: ['boss_abyss_guard', 'boss_troll_warlord'],
    levelRange: [5, 10],
    color: '#8b0000',
    mapX: 5,
    mapY: 35,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_elemental', 'mob_infernal', 'mob_ancient_protector'],
    bosses: ['boss_abyss_guard', 'boss_dragon_whelp', 'boss_void_lord'],
    levelRange: [17, 20],
    color: '#ff4500',
    mapX: 25,
    mapY: 39,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_orc_grunt', 'mob_poison_spider', 'mob_harpy', 'mob_gray_wolf', 'mob_raptor'],
    bosses: ['boss_dragon_whelp', 'boss_troll_warlord'],
    levelRange: [5, 10],
    color: '#228b22',
    mapX: 21,
    mapY: 45,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_elemental', 'mob_poison_spider', 'mob_satyr', 'mob_void_walker'],
    bosses: ['boss_abyss_guard', 'boss_demon_lord'],
    levelRange: [10, 14],
    color: '#9932cc',
    mapX: 21,
    mapY: 39,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_orc_grunt', 'mob_poison_spider', 'mob_quilboar', 'mob_makrura'],
    bosses: ['boss_dragon_whelp', 'boss_centaur_khan'],
    levelRange: [7, 11],
    color: '#8b7355',
    mapX: 16,
    mapY: 52,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_skeleton', 'mob_elemental', 'mob_scorpid', 'mob_basilisk'],
    bosses: ['boss_abyss_guard', 'boss_rock_lord'],
    levelRange: [12, 16],
    color: '#8b4513',
    mapX: 14,
    mapY: 60,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_boar', 'mob_scorpid', 'mob_quilboar', 'mob_defias'],
    bosses: ['boss_dragon_whelp', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#d4a574',
    mapX: 27,
    mapY: 53,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_boar', 'mob_gray_wolf', 'mob_brown_bear', 'mob_quilboar', 'mob_strider'],
    bosses: ['boss_abyss_guard', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#8fbc8f',
    mapX: 20,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_quilboar', 'mob_centaur', 'mob_boar', 'mob_orc_grunt', 'mob_raptor'],
    bosses: ['boss_dragon_whelp', 'boss_centaur_khan'],
    levelRange: [5, 10],
    color: '#daa520',
    mapX: 23,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_centaur', 'mob_poison_spider', 'mob_harpy', 'mob_wyrmkin'],
    bosses: ['boss_dragon_whelp', 'boss_rock_lord'],
    levelRange: [10, 14],
    color: '#cd853f',
    mapX: 20,
    mapY: 78,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_skeleton', 'mob_ogre', 'mob_scorpid', 'mob_faceless'],
    bosses: ['boss_dragon_whelp', 'boss_shadow_assassin'],
    levelRange: [11, 15],
    color: '#daa520',
    mapX: 25,
    mapY: 84,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_jungle_troll', 'mob_ogre', 'mob_naga', 'mob_wyrmkin', 'mob_dire_bear'],
    bosses: ['boss_dragon_whelp', 'boss_rock_lord'],
    levelRange: [13, 17],
    color: '#228b22',
    mapX: 15,
  ...
  },
  {
    ...
    continent: 'kalimdor',
    enemies: ['mob_silithid', 'mob_elemental', 'mob_faceless', 'mob_void_walker'],
    bosses: ['boss_abyss_guard', 'boss_void_lord'],
    levelRange: [15, 20],
    color: '#8b4513',
    mapX: 16,
    mapY: 85,
  ...
  },
  {
    ...
    enemies: ['mob_undead', 'mob_skeleton', 'mob_plaguebearer', 'mob_death_knight_mob'],
    bosses: ['boss_undead_knight', 'boss_lich', 'boss_abyss_guard', 'boss_death_lord'],
    levelRange: [15, 20],
    color: '#556b2f',
    mapX: 87,
    mapY: 35,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_ghoul', 'mob_skeleton', 'mob_plaguebearer'],
    bosses: ['boss_lich', 'boss_death_lord'],
    levelRange: [13, 17],
    color: '#4a4a4a',
    mapX: 82,
    mapY: 38,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_gray_wolf', 'mob_skeleton', 'mob_ghoul', 'mob_worgen', 'mob_wraith'],
    bosses: ['boss_undead_knight', 'boss_troll_warlord'],
    levelRange: [4, 8],
    color: '#556b2f',
    mapX: 75,
    mapY: 46,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_skeleton', 'mob_ghoul', 'mob_undead', 'mob_gray_wolf', 'mob_defias'],
    bosses: ['boss_lich', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#4a4a4a',
    mapX: 77,
    mapY: 38,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_kobold', 'mob_brown_bear', 'mob_poison_spider', 'mob_ogre', 'mob_makrura'],
    bosses: ['boss_frost_giant', 'boss_centaur_khan'],
    levelRange: [5, 10],
    color: '#4682b4',
    mapX: 77,
    mapY: 64,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_jungle_troll', 'mob_ogre', 'mob_makrura', 'mob_worgen'],
    bosses: ['boss_dragon_whelp', 'boss_naga_seawitch'],
    levelRange: [7, 12],
    color: '#556b2f',
    mapX: 85,
    mapY: 60,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_jungle_troll', 'mob_ogre', 'mob_elemental', 'mob_worgen'],
    bosses: ['boss_abyss_guard', 'boss_centaur_khan'],
    levelRange: [10, 14],
    color: '#8b7355',
    mapX: 84,
    mapY: 52,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_gray_wolf', 'mob_brown_bear', 'mob_shadow_bandit', 'mob_worgen'],
    bosses: ['boss_undead_knight', 'boss_troll_warlord'],
    levelRange: [6, 11],
    color: '#90ee90',
    mapX: 79,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_kobold', 'mob_gnoll', 'mob_gray_wolf', 'mob_boar', 'mob_shadow_bandit', 'mob_defias'],
    bosses: ['boss_abyss_guard', 'boss_hogger'],
    levelRange: [1, 5],
    color: '#228b22',
    mapX: 77,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_shadow_bandit', 'mob_skeleton', 'mob_gnoll', 'mob_defias'],
    bosses: ['boss_undead_knight', 'boss_hogger'],
    levelRange: [5, 10],
    color: '#d4a574',
    mapX: 74,
    mapY: 81,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_poison_spider', 'mob_ogre', 'mob_kobold', 'mob_raptor'],
    bosses: ['boss_dragon_whelp', 'boss_centaur_khan'],
    levelRange: [8, 12],
    color: '#cd853f',
    mapX: 83,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_skeleton', 'mob_undead', 'mob_poison_spider', 'mob_ghoul', 'mob_wraith'],
    bosses: ['boss_undead_knight', 'boss_shadow_assassin'],
    levelRange: [7, 11],
    color: '#4b0082',
    mapX: 79,
    mapY: 81,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_undead', 'mob_elemental', 'mob_void_walker'],
    bosses: ['boss_abyss_guard', 'boss_shadow_assassin'],
    levelRange: [13, 17],
    color: '#8b008b',
    mapX: 81,
    mapY: 83,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_jungle_troll', 'mob_ogre', 'mob_naga', 'mob_tiger', 'mob_orc_grunt', 'mob_raptor', 'mob_dire_bear'],
    bosses: ['boss_dragon_whelp', 'boss_troll_warlord'],
    levelRange: [10, 15],
    color: '#228b22',
    mapX: 78,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_elemental', 'mob_demon_guard', 'mob_infernal'],
    bosses: ['boss_dragon_whelp', 'boss_abyss_guard', 'boss_demon_lord'],
    levelRange: [14, 18],
    color: '#ff4500',
    mapX: 80,
    mapY: 69,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_elemental', 'mob_orc_grunt', 'mob_poison_spider', 'mob_demon_guard'],
    bosses: ['boss_dragon_whelp', 'boss_rock_lord'],
    levelRange: [12, 16],
    color: '#8b0000',
    mapX: 80,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_elemental', 'mob_ogre', 'mob_dark_iron_dwarf', 'mob_poison_spider', 'mob_basilisk'],
    bosses: ['boss_dragon_whelp', 'boss_rock_lord'],
    levelRange: [11, 15],
    color: '#a0522d',
    mapX: 85,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_murloc', 'mob_poison_spider', 'mob_jungle_troll', 'mob_elemental', 'mob_makrura', 'mob_void_walker'],
    bosses: ['boss_abyss_guard', 'boss_naga_seawitch'],
    levelRange: [8, 13],
    color: '#2f4f4f',
    mapX: 85,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_orc_grunt', 'mob_elemental', 'mob_demon_guard', 'mob_plaguebearer'],
    bosses: ['boss_abyss_guard', 'boss_dragon_whelp', 'boss_death_lord'],
    levelRange: [16, 20],
    color: '#4a0000',
    mapX: 84,
  ...
  },
  {
    ...
    continent: 'eastern_kingdoms',
    enemies: ['mob_jungle_troll', 'mob_gray_wolf', 'mob_brown_bear', 'mob_ogre', 'mob_wyrmkin'],
    bosses: ['boss_dragon_whelp', 'boss_troll_warlord'],
    levelRange: [11, 16],
    color: '#228b22',
    mapX: 87,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_vrykul', 'mob_undead', 'mob_jungle_troll', 'mob_ice_troll'],
    bosses: ['boss_lich', 'boss_death_lord'],
    levelRange: [14, 18],
    color: '#8b0000',
    mapX: 61,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_iron_dwarf', 'mob_elemental', 'mob_ice_troll', 'mob_ancient_protector'],
    bosses: ['boss_frost_giant', 'boss_dragon_whelp', 'boss_void_lord'],
    levelRange: [16, 20],
    color: '#708090',
    mapX: 56,
    mapY: 10,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_undead', 'mob_ice_troll', 'mob_dark_caster', 'mob_death_knight_mob'],
    bosses: ['boss_lich', 'boss_undead_knight', 'boss_abyss_guard', 'boss_frost_wyrm', 'boss_death_lord'],
    levelRange: [17, 20],
    color: '#b0c4de',
    mapX: 48,
    mapY: 13,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_nerubian', 'mob_jungle_troll', 'mob_elemental', 'mob_void_walker'],
    bosses: ['boss_dragon_whelp', 'boss_rock_lord'],
    levelRange: [12, 16],
    color: '#2f4f4f',
    mapX: 41,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_vrykul', 'mob_jungle_troll', 'mob_gray_wolf', 'mob_brown_bear', 'mob_worgen'],
    bosses: ['boss_frost_giant', 'boss_rock_lord'],
    levelRange: [12, 16],
    color: '#696969',
    mapX: 63,
    mapY: 31,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_undead', 'mob_wyrmkin', 'mob_death_knight_mob'],
    bosses: ['boss_dragon_whelp', 'boss_lich', 'boss_frost_wyrm', 'boss_death_lord'],
    levelRange: [15, 19],
    color: '#4a4a4a',
    mapX: 53,
    mapY: 23,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_brown_bear', 'mob_gray_wolf', 'mob_orc_grunt', 'mob_elemental', 'mob_dire_bear'],
    bosses: ['boss_undead_knight', 'boss_troll_warlord'],
    levelRange: [13, 17],
    color: '#228b22',
    mapX: 61,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_tiger', 'mob_poison_spider', 'mob_elemental', 'mob_raptor', 'mob_basilisk'],
    bosses: ['boss_dragon_whelp', 'boss_demon_lord'],
    levelRange: [14, 18],
    color: '#228b22',
    mapX: 43,
    mapY: 16,
  ...
  },
  {
    ...
    continent: 'northrend',
    enemies: ['mob_elemental', 'mob_poison_spider', 'mob_void_walker', 'mob_dark_caster'],
    bosses: ['boss_dragon_whelp', 'boss_void_lord'],
    levelRange: [16, 20],
    color: '#4169e1',
    mapX: 52,
    mapY: 17,
