...
export const CLASS_ABILITIES: { class_id: string; skills: Skill[] }[] = [
  ...
  },
  {
    ...
    skills: [
    {
      ...
      mpCost: 12,
      type: 'health_restore',
      effect: { type: 'health_restore', value: 31, statKey: 'cha' },
      unlockLevel: 1,
      cooldown: 0,
      targetType: 'single',
    ...
    },
    {
      ...
      mpCost: 20,
      type: 'health_restore',
      effect: { type: 'health_restore', value: 42, statKey: 'cha' },
      unlockLevel: 5,
      cooldown: 3,
      targetType: 'single',
      generatesResource: { type: 'holy_power', amount: 1 },
    ...
    },
    {
      ...
      resourceCost: 3,
      type: 'health_restore',
      effect: { type: 'health_restore', value: 55, statKey: 'cha' },
      unlockLevel: 9,
      cooldown: 4,
      targetType: 'single',
    },
    ...
    },
    {
      ...
      resourceCost: 4,
      type: 'magic_damage',
      effect: { type: 'magic_damage', value: 55, statKey: 'cha' },
      unlockLevel: 10,
      cooldown: 5,
      targetType: 'all_enemies'
    }
  ...
  },
  {
    ...
    skills: [
    {
      ...
      mpCost: 12,
      type: 'health_restore',
      effect: { type: 'health_restore', value: 28, statKey: 'wis' },
      unlockLevel: 1,
      cooldown: 0,
      targetType: 'single',
    },
    ...
    },
    {
      ...
      mpCost: 25,
      type: 'health_restore',
      effect: { type: 'health_restore', value: 55, statKey: 'wis' },
      unlockLevel: 9,
      cooldown: 5,
      targetType: 'single',
    },
  ...
  },
  {
    ...
    },
    {
      ...
      name: '风暴打击',
      icon: 'game-icons:lightning-branch',
    ...
    },
    {
      ...
      name: '元素之怒',
      icon: 'game-icons:elemental-wave',
  ...
  },
  {
    ...
    },
    {
      ...
      name: '真气爆裂',
      icon: 'game-icons:explosion-rings',
